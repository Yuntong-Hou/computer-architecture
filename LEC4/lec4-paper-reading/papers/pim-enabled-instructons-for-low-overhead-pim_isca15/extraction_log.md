...
- Source: https://github.com/Yuntong-Hou/computer-architecture/blob/main/LEC4/original-paper/pim-enabled-instructons-for-low-overhead-pim_isca15.pdf
- Local PDF: lec4-paper-reading/sources/original-paper/pim-enabled-instructons-for-low-overhead-pim_isca15.pdf
- Extracted Text: lec4-paper-reading/extracted_text/pim-enabled-instructons-for-low-overhead-pim_isca15.txt
- Access Status: Public PDF downloaded through GitHub API/raw URL
- Full Text Retrieved: Yes
- PDF Pages: 13
- Sections Detected: Abstract; 1 Introduction; 2 Background and Motivation; 3 PIM Abstraction; 4 Architecture; 5 Workloads and Operations; 6 Methodology; 7 Evaluation Results; 8 Related Work; 9 Conclusion; References
