...
- Source: https://github.com/Yuntong-Hou/computer-architecture/blob/main/LEC3/Google-consumer-workloads-data-movement-and-PIM_asplos18.pdf
- Access Status: 成功下载并读取本地 PDF
- Full Text Retrieved: Yes
- PDF Pages: 16
- Sections Detected: Abstract; Introduction; Background; Workload Analysis; Chrome; TensorFlow Mobile; VP9 Playback/Capture; Evaluation; Related Work; Conclusion
...
- OCR Used: No
- Extracted Text File: paper reading/extracted_text/Google-consumer-workloads-data-movement-and-PIM_asplos18.txt
