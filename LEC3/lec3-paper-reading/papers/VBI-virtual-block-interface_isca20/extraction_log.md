...
- Source: https://github.com/Yuntong-Hou/computer-architecture/blob/main/LEC3/VBI-virtual-block-interface_isca20.pdf
- Access Status: 成功下载并读取本地 PDF
- Full Text Retrieved: Yes
- PDF Pages: 14
- Sections Detected: Abstract; Introduction; VBI Overview; Detailed Design; Optimizations; Evaluation; Related Work; Conclusion
...
- OCR Used: No
- Extracted Text File: paper reading/extracted_text/VBI-virtual-block-interface_isca20.txt
